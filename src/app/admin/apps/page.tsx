...
export default function AppsAdminPage() {
  ...
  const { data: apps, isLoading } = useCollection<WorkItem>(appsQuery);
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      ...
      <header className="flex justify-between items-center mb-8">
        <h1 className="font-headline text-3xl md:text-4xl font-bold">アプリ管理</h1>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-w-3xl">
          <DialogHeader>
            <DialogTitle>{selectedWorkItem ? 'アプリを編集' : 'アプリを新規作成'}</DialogTitle>
          </DialogHeader>
          <WorkForm
